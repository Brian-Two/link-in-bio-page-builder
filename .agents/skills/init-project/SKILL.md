---
name: init-project
description: Initialize and start the project locally with environment setup, dependencies, database, and dev server. Use when setting up the project for the first time or onboarding.
---
