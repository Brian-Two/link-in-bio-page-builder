---
name: create-rules
description: Generate CLAUDE.md global rules from codebase analysis. Use when setting up project conventions, onboarding agents, or creating agent context files.
---
